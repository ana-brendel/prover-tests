...
(* Theorem leftist_hinsert : forall (x : heap) (n : nat), has_leftist_property x = true -> has_leftist_property (hinsert x n) = true. *)

Theorem leftist_hinsert_mulit (n: nat) (l: lst) (h: heap) (H: has_leftist_property h = true)
(IHl: has_leftist_property (hinsert_all l h) = true) : has_leftist_property (hinsert (hinsert_all l h) n) = true.
Proof. Admitted.
